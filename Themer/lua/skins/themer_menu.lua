...
SKIN.PrintName 		= "Themer (Menu State)"
SKIN.Author 		= "Cynosphere"
SKIN.DermaVersion	= 1
local S = "gwenskin/" .. Cashout.Plugins:GetOption("themer", "theme") .. ".png"
...
derma.DefineSkin( "themer_menu", "Themer - Menu Plugins Port", SKIN )
